...
nasm -DISUNIX=1 -f elf64 addsig2vol_3_64.asm -o./addsig2vol_3_64.o
gcc -g -O2 -c -I./munit ./munit/munit.c -o ./builds/munit.o
gcc -g -O2 -c -I./* -I/usr/include/octave-4.0.3/octave/ -I/usr/include as2v_array.c  -o ./builds/as2v_array.o
gcc -g -O2 -c -I./* -I/usr/include timestats.c  -o ./builds/timestats.o
gcc -g -O2 -c -I./* -I/usr/include threadstats.c  -o ./builds/threadstats.o
gcc -g -O2 -c -I./* -I/usr/include/octave-4.0.3/octave/ -I/usr/include addsig2vol_3.c -o./builds/addsig2vol_3_asm.o
gcc -g -O2 -c -I./* -I/usr/include/octave-4.0.3/octave/ -I/usr/include -I./munit  addsig2vol_3_unittests.c -o./builds/addsig2vol_3_unittests.o
...
nasm -DISUNIX=1 -f elf64 addsig2vol_3_64.asm -o./addsig2vol_3_64.o
mkoctfile --mex -DBUILDMEX -v -I. -I/usr/include/octave-4.0.3/octave/ -I./munit/ as2v_array.c timestats.c threadstats.c ./munit/munit.c addsig2vol_3.c addsig2vol_3_mex.c -o ./addsig2vol_3_sticky ./addsig2vol_3_64.o
